...
const DEMO_TABLES: Table[] = [
  ...
  { id: 2, name: 'Bàn 2', is_occupied: true },
  { id: 3, name: 'Bàn 3', is_occupied: false },
  { id: 4, name: 'Bàn 4', is_occupied: false },
  { id: 5, name: 'Bàn 5', is_occupied: true },
  { id: 6, name: 'Bàn VIP 1', is_occupied: false },
  { id: 7, name: 'Bàn VIP 2', is_occupied: false },
  { id: 8, name: 'Bàn ngoài 1', is_occupied: false }
]
