  ...
  <div class="min-h-screen bg-gray-50 flex w-full">
    ...
    <aside class="w-64 bg-white border-r border-gray-200 flex-shrink-0 h-screen sticky top-0 flex flex-col">
      ...
      <nav class="p-4 space-y-1 flex-1 overflow-y-auto">
        ...
        <!-- End Shift Button -->
        <button
          @click="openEndShiftModal"
          class="sidebar-item w-full mt-4 bg-red-50 hover:bg-red-100 text-red-700 border border-red-200"
        >
          <EndShiftIcon class="w-5 h-5" />
          <span>Kết ca</span>
        </button>
      </nav>
...
// Icons
const TableIcon = () => h('svg', { class: 'w-5 h-5', fill: 'none', viewBox: '0 0 24 24', stroke: 'currentColor' }, [
  h('path', { 'stroke-linecap': 'round', 'stroke-linejoin': 'round', 'stroke-width': '2', d: 'M4 6h16M4 10h16M4 14h16M4 18h16' })
])

const SummaryIcon = () => h('svg', { class: 'w-5 h-5', fill: 'none', viewBox: '0 0 24 24', stroke: 'currentColor' }, [
...
const EndShiftIcon = () => h('svg', { class: 'w-5 h-5', fill: 'none', viewBox: '0 0 24 24', stroke: 'currentColor' }, [
...
const menuItems = [
  { name: 'Chọn bàn', path: '/client', icon: TableIcon },
  { name: 'Tổng kết ca', path: '/client/summary', icon: SummaryIcon }
]
